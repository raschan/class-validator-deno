...
describe("nested validation", function () {
    ...
    it("should validate nested objects", function () {
        ...
        return validator.validate(model).then((errors) => {
            ...
            subSubSubError3.constraints.should.be.eql({
                minLength: "name must be longer than or equal to 5 characters",
            });
            ...
            subSubSubError4.target.should.be.equal(
                model.mySubSubSubClasses[0][0]
            );
            subSubSubError4.value.should.be.equal(
            ...
            subSubSubSubError4.target.should.be.equal(
                model.mySubSubSubClasses[0][0][0]
            );
            subSubSubSubError4.property.should.be.equal("name");
            subSubSubSubError4.constraints.should.be.eql({
                minLength: "name must be longer than or equal to 5 characters",
            });
