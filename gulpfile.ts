...
export class Gulpfile {
  ...
  @Task()
  packageCompileEsm5() {
    const tsProjectEsm5 = ts.createProject(
      "tsconfig.json",
  ...
  packageCompileEsm2015() {
    const tsProjectEsm2015 = ts.createProject(
      "tsconfig.json",
      { module: "esnext", target: "es2018" },
    );
  ...
  private _rollupPackageBundleEsm5(isMin: boolean) {
    return rollup({
      ...
      return bundle.write({
        file: this._getOutputFileName(
          resolve(__dirname, "dist/bundles/index.umd.js"),
          isMin,
        ),
        format: "umd",
  ...
  private _rollupPackageBundleEsm2015(isMin: boolean) {
    return rollup({
      ...
      return bundle.write({
        file: this._getOutputFileName(
          resolve(__dirname, "dist/bundles/index.esm.js"),
          isMin,
        ),
        format: "es",
        sourcemap: true,
